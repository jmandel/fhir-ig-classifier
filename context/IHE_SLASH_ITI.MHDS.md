File: repos/IHE_SLASH_ITI.MHDS/sushi-config.yaml
...
// File: input/images-source/DocumentRegistryActor.plantuml
...
// File: input/images-source/MHDS_controlled_exchange.plantuml
...
feedback:
  - active: true
    dashboard:
      label: New Issue
      url: https://github.com/IHE/ITI.MHDS/issues/new/choose
  - active: true
    dashboard:
      label: Issues
      url: https://github.com/IHE/ITI.MHDS/issues

File: repos/HL7Sweden_SLASH_basprofiler-r4/sushi-config.yaml
...
# ╭──────────────────────────ImplementationGuide-hl7.fhir.uv.snomed.json───────────────────────────╮
...
title: Swedish Base Profiles Implementation Guide
status: active
publisher:
  name: HL7 Sweden
  url: http://hl7.se/
...
# ╰────────────────────────────────────────────────────────────────────────────────────────────────╯
#indexPageContent: Describes how to use SNOMED CT in FHIR
